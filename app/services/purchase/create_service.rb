    ...
    begin
      ...
      if params[:accepted_offer].present?
        ...
        if upsell.cross_sell?
          ...
          purchase.offer_code = upsell.offer_code if upsell.offer_code.present? && !params[:is_purchasing_power_parity_discounted]
        end
  ...
  private
    ...
    def build_purchase(params_for_purchase)
      ...
      if purchase.discount_code.present?
        purchase.offer_code = product.find_offer_code(code: purchase.discount_code)
      end
