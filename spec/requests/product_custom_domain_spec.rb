...
describe "ProductCustomDomainScenario", type: :system, js: true do
  ...
  context "when there is a discount code" do
    ...
    let(:offer_code) { create(:percentage_offer_code, products: [product], code: "launch") }

    context "when the URL contains only the discount code" do
    ...
    context "when the URL contains both the discount code and the product" do
      it "applies the discount code" do
